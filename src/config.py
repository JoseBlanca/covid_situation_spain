...
PLOT_PARAM_DESCRIPTIONS = {
    ORIG_CASES_COL: "Num. casos",
...
AGE_COMMUNITY_GROUP_PLOT_DIR = AGE_GROUP_PLOT_DIR / "communities"
AGE_COMMUNITY_GROUP_PLOT_DIR.mkdir(exist_ok=True)

FOR_PANEL_EVOLUTION_FIG_SIZE = (8, 11)
THREE_PANEL_EVOLUTION_FIG_SIZE = (8, 8)
